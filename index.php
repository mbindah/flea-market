...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Flea Market System - Administrator Homepage</title>  
...
<td><button class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure you want to delete this anouncement?')?window.location.href='insertion.inc.php?action=deleteA&id=<?php echo($row["Announcement_ID"]); ?>':true;" title='Delete Announcement'>Delete</button></td>
</tr>
<?php
}
} else { echo "No results"; }
                    ...
                    <div class="contact_form">
                        ...
                        <form class="row" action="insertion.inc.php" name="contactform" method="post">
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" required name="password" id="pass1" class="form-control" placeholder="Your Password">
                                     <input type="checkbox" onclick="myFunction1()"> Show Password
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" required name="cpassword" id="pass2" class="form-control" placeholder="Confirm Your Password">
                                ...
                                <br>
                                <div class="col-lg-3 col-md-6 col-sm-3 col-xs-12 text-center">
                                    <button type="submit" name="regu" id="" class="btn btn-light btn-radius btn-brd grd1 btn-block">Register</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
                ...
                <div class="col-md-12" id="register">
                    <div class="contact_form">
                        ...
                        <form class="row" action="insertion.inc.php" name="contactform" method="post">
                            <fieldset class="row-fluid">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" required name="mname" id="" class="form-control" placeholder="Announcement Name">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <textarea required name="mdet" class="form-control" placeholder="Announcement Details..."></textarea>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" min="<?php echo date('Y-m-d'); ?>" required name="mdate" class="form-control">
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-3 col-xs-12 text-center">
                                <button type="submit" name="adda" id="" class="btn btn-light btn-radius btn-brd grd1 btn-block">Add</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
